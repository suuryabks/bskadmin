...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      email: 'Woodrow_Hauck37@yahoo.com',
      name: 'Sally Howell',
      userType: 892,
      PAN: 'success',
      ReferedBy: '62b4bbfbff795068acc6ac76',
      ReferalID: 'Center',
      phone: 910,
      image: 'back',
      isWhatsapp: false,
      mobileNo: '(671) 154-6140',
      password: 'vNDh8pYQj9FluWo',
      username: 'Jimmie_OHara40',
      resetPasswordLink: {},
      loginRetryLimit: 889,
      loginReactiveTime: '2022-12-11T09:49:47.013Z',
      id: '62b4bbfbff795068acc6ac77'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'email':'Blanche44@hotmail.com',
        'name':'Roberto Wolff',
        'userType':authConstant.USER_TYPES.User,
        'PAN':'Home',
        'ReferedBy':insertedUser.insertedId,
        'ReferalID':'neural',
        'phone':572,
        'image':'didactic',
        'isWhatsapp':false,
        'mobileNo':'(254) 261-0304',
        'password':'gw6iMEn0g2WswOX',
        'username':'Lindsay.Cummerata0',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Blanche44@hotmail.com', });
