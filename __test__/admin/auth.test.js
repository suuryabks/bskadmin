...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      email: 'Donato.Gleason81@hotmail.com',
      name: 'Mr. Mike Fay',
      userType: 445,
      PAN: 'internet',
      ReferedBy: '62b4bbfbff795068acc6abf2',
      ReferalID: 'Liaison',
      phone: 523,
      image: 'microchip',
      isWhatsapp: true,
      mobileNo: '(411) 448-3873',
      password: '8i3Q28sZ9I26_uL',
      username: 'Abagail58',
      resetPasswordLink: {},
      loginRetryLimit: 139,
      loginReactiveTime: '2023-05-13T09:03:27.026Z',
      id: '62b4bbfbff795068acc6abf3'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'email':'Esteban_Ernser28@hotmail.com',
        'name':'Cecil Mitchell',
        ...
        'image':'compressing',
        'isWhatsapp':false,
        'mobileNo':'(266) 607-3407',
        'password':'m86KE9WUyutC2jM',
        'username':'Mertie_Mosciski',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Esteban_Ernser28@hotmail.com', });
